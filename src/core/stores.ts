...
import { assign, assignImpure } from 'src/util/assign';
import { clone } from 'src/util/clone';
import { findTriggers } from 'src/util/findTriggers';
import { getInternal } from 'src/util/get';
import { isFormValidImpure } from 'src/util/isFormValid';
import { mergeRightDeepImpure } from 'src/util/mergeRightDeep';
import { prependImpure } from 'src/util/prepend';
import { removePropertyImpure } from 'src/util/removeProperty';
import { setImpure } from 'src/util/set';
import { get, writable } from 'svelte/store';

export const createForm = <T extends object, V extends object = ValidatorFields<T>>({
	initialValues,
	initialDeps = {},
	...formOptions
